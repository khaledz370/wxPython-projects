...
export const TOOLS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { type: 'check', key: 'singleFolder', label: 'All files in one folder', default: true, hint: 'off: each file gets its own <name>_extracted folder' },
      { type: 'path', key: 'outDir', mode: 'folder', label: 'Output folder', placeholder: 'next to each file, in an "extracted" folder' },
    ],
