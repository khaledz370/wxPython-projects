...
export class SettingsPage {
  ...
  build() {
    ...
    renderFields(form, [
      ...
      { type: 'text', key: 'backupDir', label: 'Backup folder', placeholder: '_originals', show: (v) => v.originalPolicy === 'backup',
        hint: 'A name like _originals creates that folder next to each file. A full path like D:\\Backup collects everything in one place.' },
